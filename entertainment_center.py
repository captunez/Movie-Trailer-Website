...
boss_baby = media.Movie(
    ...
    "https://www.youtube.com/watch?v=RBfCQuQqgNs&list=PLHPTxTxtC0ibCJB1vtN_-cwL5X-yPiPyO&feature=c4-overview-vl")
...
ghost_in_shell = media.Movie(
    ...
    "https://www.youtube.com/watch?v=N8ATvx7LT0c&list=PLHPTxTxtC0ibCJB1vtN_-cwL5X-yPiPyO&feature=c4-overview-vl")

# Gifted movie: movie title, poster image and movie trailer
gifted = media.Movie(
    "Gifted",
    "https://i.ytimg.com/vi/j3phtzCWAgg/movieposter.jpg",
    "https://www.youtube.com/watch?v=j3phtzCWAgg&list=PLHPTxTxtC0ibCJB1vtN_-cwL5X-yPiPyO&feature=c4-overview-vl")
